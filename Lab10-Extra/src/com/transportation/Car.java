...
public class Car extends Vehicle {
    ...
    /*
    If location is west seattle, then throw a destination unreachable exception
     */
    public void moveTo(String location) throws DestinationUnreachableException {
        if (location.equals("West Seattle")){
            throw new DestinationUnreachableException("We can't get to " + location + " due" +
                    " to bridge shutting down.");
        } else {
